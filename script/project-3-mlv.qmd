...
## Let M be the median and let 𝜋(𝑀<0)=𝑃(𝑀<0) . Estimate 𝜋(𝑀<0) , Estimate the distribution of 𝜋̂(𝑀<0) and construct a 95% C.I. for 𝜋(𝑀<0).
